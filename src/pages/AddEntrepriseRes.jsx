...
const AddEntrepriseRes = ({entreprise,setEntreprise}) => {
   ...
   const submitHierarchicalUnits = async () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const entrepriseData = { ...entreprise, hierarchicalUnitIds: unitsIds };
                                ...
                                <AccordionPanel>
                                    <div className="grid grid-cols-2 gap-4">
                                        ...
                                        <div className="col-span-2">
                                            ...
                                            <Select
                                                options={[
                                                    { value: null, label: "No parent (root unit)" }, // Default option for no parent
                                                ...
                                                placeholder="Select parent or leave as 'No parent'"
                                                styles={customStyles}
...
export default AddEntrepriseRes;