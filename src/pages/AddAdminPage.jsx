...
import PhoneInput from 'react-phone-input-2'; // Importing react-phone-input-2
import 'react-phone-input-2/lib/style.css'; // Adding CSS for react-phone-input-2
...
const AddAdminPage = () => {
    ...
    const [num, setNum] = useState(''); // Using react-phone-input-2 for phone number
 ...
 const validateForm = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        formData.append('num', num); // Phone number will include country code
        ...
        try {
            await axiosInstanceForRessources.post('/auth/register-admin', formData);
            toast.success(t('add_responsable.addUserSuccess'), { position: "top-right" });
            setMatricule('');
            setFirstName('');
            setMatricule('');
            setLastName('');
