...
const [matricule, setMatricule] = useState('');
  ...
  useEffect(() => {
        if (selectedEntreprise && role === "PARTICIPANT") {
    ...
    const handleSubmit = async (e) => {
        ...
        formData.append('entrepriseName', selectedEntreprise);
        ...
        try {
            await axiosInstanceForRessources.post('/auth/register', formData);
...
const handleFileUpload = async (e) => {
    ...
    reader.onload = async (event) => {
        ...
        console.log('JSON Data:', jsonData); // Debugging: Check the keys
        ...
        try {
            for (let i = 0; i < jsonData.length; i++) {
                ...
                // Append common fields using exact header names
                ...
                formData.append('num', user['Phone Number']);
                // Assuming gender is another field; ensure it's present in Excel
                ...
                console.log("unit : ", user['Unit Name (for Participants)']);
                console.log("entreprise : ", user['Entreprise Name']);

                // Handle additional fields based on role
                if (user['Role'] === 'FORMATEUR') {
                    formData.append('typeFormateur', user['Type Formateur (for Formateurs)']);
                    if (user['Type Formateur (for Formateurs)'] && user['Type Formateur (for Formateurs)'].toUpperCase() === 'EXTERN') {
                        formData.append('cabinetName', user['Cabinet Name (for Formateurs)'] || '');
                        formData.append('cabinetNum', user['Cabinet Num (for Formateurs)'] || '');
                    }
                } else if (user['Role'] === 'PARTICIPANT') {
                    formData.append('unitName', user['Unit Name (for Participants)'] || '');
                }

                formData.append('entrepriseName', user['Entreprise Name']);
            ...
            <div className="max-w-md w-full space-y-8 bg-white p-8 rounded-lg shadow-md">
                ...
                <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
                    <div className="rounded-md shadow-sm -space-y-px">
                        <div className="mb-4">
                            <label htmlFor="firstName" className="sr-only">Matricule Id</label>
                            <input
                                id="matricule"
                                name="matricule"
                                type="text"
                        ...
                        <div className='mb-4' >
                            <label htmlFor="age" className="sr-only">Cin</label>
                            <input
                                id="cin"
                                type="text"
                                name="cin"
                        ...
                        <div className="mb-4">
                            <Select
                                ...
                                onChange={(option) => setSelectedEntreprise(option.value)}
                                placeholder={t('selectEntreprise')}
                                styles={customStyles}
                            />
                        </div>
                        ...
                        <div className="mb-4">
                            ...
                            >
                                ...
                                <option value="FORMATEUR">{t('formateur')}</option>
                                <option value="RESPONSABLE">{t('responsable')}</option>
            ...
            {role === 'PARTICIPANT' && (
                ...
                <div className="max-w-md mx-auto p-6 bg-white rounded-lg shadow-md mt-6 space-y-6">
                    <div className="flex flex-col items-center space-y-4">
                        ...
                        <h3 className="text-xl font-semibold text-gray-800">{t('uploadExcel')}</h3>
