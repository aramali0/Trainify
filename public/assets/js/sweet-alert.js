...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.getElementById('custom-html-alert').addEventListener('click', function () {
        Swal.fire({
            ...
            cancelButtonColor: "#f46a6a",
            confirmButtonText: '<i class="ph-fill ph-thumbs-up me-1"></i> Great!',
            cancelButtonText: '<i class="ph-fill ph-thumbs-down"></i>'
        });
    });
    ...
    document.getElementById('ajax-alert').addEventListener('click', function () {
        Swal.fire({
            ...
            input: 'email',
            customClass: {
                input: "!py-2 !px-4 !h-12 block bg-white !border-default-200 rounded-md text-sm dark:bg-default-50 text-default-800",
            },
